...
export function SignUpForm(): React.JSX.Element {
  ...
  const schema = zod.object({
    ...
    password: zod
      .string()
      .min(6, { message: t("auth.fields.validation.passwordMinLength") }),
    terms: zod
      .boolean()
      .refine((value) => value, t("auth.fields.validation.terms")),
  });
  ...
  const onSubmit = React.useCallback(
    async (values: Values): Promise<void> => {
      ...
      try {
        ...
        enqueueSnackbar(t("auth.accountCreated", { email: values.email }), {
          variant: "success",
        });
                ...
                <FormControlLabel
                  ...
                  label={
                    <Trans
                      ...
                      components={[
                        <Link component={RouterLink} to={routes.terms}></Link>,
                      ]}
                    />
                  }
                />
